...
>
  ...
  <div>
  <header className="usa-header usa-header--basic margin-top-neg-1">
  <div className="usa-nav-container">
          
          <div className="usa-logo display-inline-flex">
          
            <img className="usda-logo-img" width="70px" height="70px" src="/ppp/img/usa-icons/usda-symbol.svg" alt="USDA Logo"/>
