          ...
          <legend className="usa-legend text-bold">Search Options</legend>
            <div className="grid-row grid-gap">
              ...
              <div><input className="usa-input grid-col-auto" title="Award ID" id="input-award_id" name="input-award_id" placeholder="Award ID" type="text" onChange={(e) => requestSearch(e.target.value)}/></div>
                ...
                <div className="usa-checkbox grid-col-auto">
                  <input
                    ...
                    checked="checked"
                    onChange={(e) => handleLatestVersion(e.target.selectedOptions)} 
                  />
                </div> 
      ...
      <div className="grid-container margin-top-2">
        <fieldset className="usa-fieldset" hidden={hideAdavanceOptions}>
          <legend className="usa-legend text-bold">Advanced Search Options</legend>
            ...
            <div id="perf_dt_outer" className="usa-date-picker usa-date-picker--initialized usa-date-picker--active" data-min-date="0000-01-01">
              ...
              <div> <select className="usa-select grid-col-auto" title="Solicitation Method" id="input-sol_method" name="input-sol_method"  onChange={(e) => handleSolMethod(e.target.selectedOptions)} defaultValue={" "}>
                ...
                <div className="usa-checkbox grid-col-auto">
                  <input
                    ...
                    id="check-historical-truth"
                    type="checkbox"
                    name="Active Solicitation"
                    value="Active Solicitation"
                    checked="checked"
                    onChange= {(e) => handleActiveSolicitation(e.target.selectedOptions)} 
                  />
                </div> 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 24 24" width="1em" className="usa-icon usa-icon--size-2" focusable="false" role="img"><path d="M15.17 15 13 17.17V6.83L15.17 9l1.41-1.41L12 3 7.41 7.59 8.83 9 11 6.83v10.34L8.83 15l-1.41 1.41L12 21l4.59-4.59L15.17 15z"></path></svg>
            ...
            <tbody>
            {
              ...
              }className="margin-05" src = "/dist/assets/content_copy.svg" alt="Copy Solicitation Link" width="15px" height="15px"/></div>  </td>
        ...
        <div className="usa-prose display-inline-flex">
          ...
          {links.map((link) => (
               <li key={link.name}>
                ...
                }className="margin-05" src = "/dist/assets/content_copy.svg" alt="Copy Solicitation Link" width="15px" height="15px"/>
