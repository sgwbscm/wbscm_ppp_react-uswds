...
export default function App() {
  ...
  {
    let url  = "https://d2ovuhpmzxq259.cloudfront.net/?solicitation="+solURL;
                ...
                <tr key={i}>
                  <td >
                    <div className="display-inline-flex">
                      <a  title={file.sol_num} href={"https://d2ovuhpmzxq259.cloudfront.net/?solicitation="+file.sol_num}>{file.sol_num}</a>
                      <img  title="Copy Solicitation Link" onClick={ async ()=>{
                  let url  = "https://d2ovuhpmzxq259.cloudfront.net/?solicitation="+file.sol_num;
                  await navigator.clipboard.writeText(url);
                }
